            ...
            <div className="profile-container" id="profile-container">
                ...
                <div>
                    ...
                    <div className="profile-info" id="profile-info">
                        ...
                        <label className="profile-email" id="profile-email" onClick={this.handleEditEmail}>Email:</label><br/><br/>
                        ...
                        <label className="profile-last-name" id="profile-last-name" onClick={this.handleEditLastName}>Last Name: </label><br/><br/>
                    </div>
